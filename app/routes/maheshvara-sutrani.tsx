            ...
            <div className="px-4 md:px-12 pb-16">
              ...
              <div className="space-y-6 text-center">
                {maheshvaraSutras.map((sutra, index) => {
                  ...
                  const renderSutraWithHighlights = (
                    text: string,
                    sutraIndex: number
                  ) => {
                    const parts = [];
                  ...
                  return (
                    <div
                      key={index}
                      className="text-2xl md:text-4xl leading-relaxed font-bold text-black"
                      style={{ fontFamily: "serif" }}
                    >
              ...
              {/* Closing Statement */}
              <div
                className="text-center mt-12 text-xl md:text-2xl font-bold text-black"
                style={{ fontFamily: "serif" }}
              >
